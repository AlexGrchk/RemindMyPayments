...
struct MonthView<DateView>: View where DateView: View {
    ...
    func getWeekDaysSorted() -> [String]{
        ...
        let sortedWeekDays = Array(weekDays[Calendar.current.firstWeekday - 1 ..< Calendar.current.veryShortWeekdaySymbols.count] + weekDays[0 ..< Calendar.current.firstWeekday - 1])
